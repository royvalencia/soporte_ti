...
class ReportesController extends AppController
{
    ...
    public function index()
    {
        ...
        $serviciosUsuarios = $this->Servicios->find('all',
                                                ['contain'=>['CoUsers'],
                                                'fields'=>['Servicios.co_user_id','CoUsers.nombre','CoUsers.co_user_id','esfuerzo'=>'SUM(Servicios.esfuerzo)'],
                                                'conditions'=>['Servicios.fecha_solicitud >='=>$inicio,'Servicios.fecha_solicitud <='=>$fin],        
                                                'group'=>['Servicios.co_user_id']])->select(['Servicios.co_user_id',
                                                                                                        'count' => $this->Servicios->find()->func()->count('*')])->order(['count'=>'ASC']);   
        
       // pr($serviciosUsuarios);
       // exit;                                                                                                
        ...
        $serviciosTipo = $this->Servicios->find('all',
                                                ...
                                                'fields'=>['Grupos.descripcion','Servicios.tipo_servicio_id','TipoServicios.descripcion','TipoServicios.tipo_servicio_id','esfuerzo'=>'SUM(Servicios.esfuerzo)'],
                                                'conditions'=>['Servicios.fecha_solicitud >='=>$inicio,'Servicios.fecha_solicitud <='=>$fin],
        ...
        $this->set(compact('servicios','inicio','fin','serviciosArea','serviciosUsuarios','serviciosEstatus','serviciosTipo','serviciosTipoGrupo'));
