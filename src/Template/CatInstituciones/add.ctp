        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div class="ibox-title">
                 <h5><i class="fa fa-edit"></i> <?= __('Agregar Cat Institucione') ?></h5>                    
               </div>               
            ...
            ?>      
             <?= $this->Form->create($catInstitucione) ?>
                 <fieldset>
                    <legend></legend>
        <?php
            echo $this->Form->input('num_adscripcion');
            echo $this->Form->input('num_organo');
            echo $this->Form->input('nombre');
            echo $this->Form->input('tipo_institucion_id');
            echo $this->Form->input('estado');
            echo $this->Form->input('bloquear_funciones');
            echo $this->Form->input('rfc');
            echo $this->Form->input('partida_convertida_sag');
        ?>
