         ...
         <div class="col-lg-12">
             <div class="ibox float-e-margins">
                 <div class="ibox-title">
                     <h5><i class="fa fa-edit"></i> <?= __('Editar VPN') ?></h5>
                 </div>
                    ...
                    <?= $this->Form->create($vpn) ?>
                     <fieldset>
                        ...
                        <div class="form-group required">
                            <label for="fecha_limite_solucion" class="col-sm-3 control-label">Fecha Entrega VPN</label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    <input name="fecha_entrega" value="<?php echo date_format($vpn->fecha_entrega, 'Y-m-d'); ?>" class="form-control tipoFecha" type="text" id="fecha_entrega" required="required"/>
                                </div>
                            </div>
                        </div> 
