        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div class="ibox-title">
                 <h5><i class="fa fa-edit"></i> <?= __('Agregar Adjunto') ?></h5>                    
               </div>               
                  ...
                  <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group pull-right"> 
                       <?php echo $this->Html->link('<i class="fa fa-list" ></i>', array('action' => 'index'), array('class' => 'btn btn-default','rel' => 'tooltip','title'=>'Lista de Adjuntos ','escape' => false)); ?>
                                        ...
                                        <div class="btn-group pull-right">
                           <?= $this->Html->link(__('<i class="fa fa-list-ul"></i> '), ['controller' => 'Vpns', 'action' => 'index'],['class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Lista de VPNs']) ?>
                           <?= $this->Html->link(__('<i class="fa fa-plus-circle"></i> '), ['controller' => 'Vpns', 'action' => 'add'],['class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Nuevo VPN ']) ?>
                       </div>
                                       </div> 
                </div>
            </div>
            ...
            ?>      
             <?= $this->Form->create($adjuntocd, ['type' => 'file']) ?>
                 <fieldset>
                    <legend></legend>
        <?php
            
            echo $this->Form->input('descripcion');
            echo $this->Form->input('archivo', ['type' => 'file']);
            echo $this->Form->input('idvpn', ['value' => $idvpn]);
        ?>
