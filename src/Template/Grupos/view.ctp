        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div class="ibox-title">
                 <h5><i class="fa fa-th"></i> <?= __('Detalle de Módulo');?> </h5>                    
               </div>               
                 ...
                 <table class="table table-striped table-detalle" style="width: 100%;">
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $grupo->has('co_group') ? $this->Html->link($grupo->co_group->name, ['controller' => 'CoGroups', 'action' => 'view', $grupo->co_group->co_group_id]) : '' ?></td>
