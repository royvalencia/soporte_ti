        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div class="ibox-title">
                 <h5><i class="fa fa-edit"></i> <?= __('Agregar Permisos desde Controlador') ?></h5>                    
               </div>               
                ...
                <div class="col-md-12">
                  <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group pull-right"> 
                       <?php echo $this->Html->link('<i class="fa fa-list" ></i>', array('action' => 'index'), array('class' => 'btn btn-default','rel' => 'tooltip','title'=>'Lista de Co Permissions ','escape' => false)); ?>
                     </div>
            ...
            ?>      
             <?= $this->Form->create($coPermission) ?>
                 <fieldset>
                    <legend></legend>
        <?php
            echo $this->Form->input('coPermissions',['options'=>$controladores,'default'=>$controladores,'label'=>'Permisos','multiple'=>'multiple','required'=>'required']);
            echo $this->Form->input('co_groups._ids', ['options' => $coGroups,'label'=>'Grupos','required'=>'required']);
        ?>
