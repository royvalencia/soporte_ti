         ...
         <div class="col-lg-12">
             <div class="ibox float-e-margins">
                 <div class="ibox-title">
                     <h5><i class="fa fa-plus"></i> <?= __('Agregar Servidor') ?></h5>
                 </div>
            ...
            <?php echo $this->Form->create($server); ?>
                ...
                //echo $this->Form->input('usuario',array('label'=>array('text'=>'Usuarios del Servidor')));
                //echo $this->Form->input('password',array('label'=>array('text'=>'Contraseña del Servidor')));
