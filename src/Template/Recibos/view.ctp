        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div class="ibox-title">
                 <h5><i class="fa fa-th"></i> <?= __('Detalle de  Recibo');?> </h5>                    
               </div>               
                ...
                <div class="col-md-12">
                  <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group pull-right"> 
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-edit"></i>', array('action' => 'edit', $recibo->id), array('class' => 'btn btn-default','rel' => 'tooltip','title' => 'Editar','escape' => false)); ?>
                        <?php echo $this->Form->postLink('<i class="fa fa-trash-o"></i>', array('action' => 'delete',$recibo->id), array('class' => 'btn btn-default','rel' => 'tooltip','title' => 'Eliminar','escape' => false), __('¿Seguro que desea eliminar el registro # %s?', $recibo->id)); ?> 
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-list" ></i>', array('action' => 'index'), array('class' => 'btn btn-default','rel' => 'tooltip','title'=>'Lista de Recibos','escape' => false)); ?> 
                             ...
                             <div class="btn-group pull-right">                                                                   
                                 ...
                                 ?>                               
                                                        ...
                                                        <div class="btn-group pull-right">                                                                   
                                  <?php
                                    echo $this->Html->link( '<i class="fa fa-list-ul"></i>', array('controller' => 'Estatus', 'action' => 'index'), array('class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Lista de Estatus'));
                                    echo $this->Html->link( '<i class="fa fa-plus-circle"></i>', array('controller' => 'Estatus', 'action' => 'add'), array('class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Nuevo Estatus '));
                                   
                                 ?>                               
                              </div>    
                                                        <div class="btn-group pull-right">                                                                   
                                  <?php
                                    echo $this->Html->link( '<i class="fa fa-list-ul"></i>', array('controller' => 'FormaPagos', 'action' => 'index'), array('class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Lista de Forma Pagos'));
                                    echo $this->Html->link( '<i class="fa fa-plus-circle"></i>', array('controller' => 'FormaPagos', 'action' => 'add'), array('class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Nuevo Forma Pago '));
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $recibo->has('contrato') ? $this->Html->link($recibo->contrato->id, ['controller' => 'Contratos', 'action' => 'view', $recibo->contrato->id]) : '' ?></td>
                                ...
                                <tr>
                        <td class="field"><?= __('Vencimiento') ?></td>
                    ...
                    <tr>
                        ...
                        <td><?= $recibo->has('forma_pago') ? $this->Html->link($recibo->forma_pago->id, ['controller' => 'FormaPagos', 'action' => 'view', $recibo->forma_pago->id]) : '' ?></td>
                                ...
                                <tr>
                        <td class="field"><?= __('Fecha Pago') ?></td>
