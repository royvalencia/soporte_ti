<?php 
$url_actual = "http://" . $_SERVER["SERVER_NAME"]."/soporte_ti/webroot/img/encabezado_oficio.png";
?>
<div><img src="<?=$url_actual?>" /></div>
        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div align="center">
                 ...
                 <h5><?= __('');?><br><?= __('DIRECCIÓN GENERAL DE TECNOLOGÍAS DE LA INFORMACIÓN Y COMUNICACIONES');?><br><?= __('Cédula de Solicitudes');?> </h5>                                          
               </div> 
          </div>
        </div>    
    </div>
