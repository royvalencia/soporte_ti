                           ...
                           <div class="dropdown-messages-box">
                              ...
                              <td>
                                  <div class="media-body">
                                      ...
                                      <medium class="text-muted">De: <font color="blue"><?= h($servicio->co_user->nombre) ?></font> <?php if ($tipo!=4){ ?>Asignado a: <font color="green"><?= h($agentes[$servicio->agente]) ?></font> Módulo: <?= $servicio->grupo->descripcion ?> <?php }?> </medium> <br>
                                      <small class="text-muted">
                                          ...
                                          echo $tiempo_transcurrido; ?></small>
                                  </div>
                              </td>
                              <?php
