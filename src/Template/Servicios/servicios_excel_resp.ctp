...
<table cellpadding="0" cellspacing="0">
    ...
    <?php $tableHeaders =  $this->Html->tableHeaders(array('Folio','Asunto','Estado','Prioridad','Fecha','Tipo','Grupo','Dependencia','Dirección','Solicitante','Modulo','Usuario','Agente'));
...
<?php
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $servicio->solicitante->nombre; ?>
		</td>
		<td>
