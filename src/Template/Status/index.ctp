          ...
          <?php foreach ($status as $status): ?>
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('<i class="fa fa-trash-o" ></i>'), ['action' => 'delete', $status->statu_id], ['class' => 'btn btn-default btn-sm','rel' => 'tooltip','title'=>'Eliminar','escape' => false,'confirm' => __('¿Seguro que desea eliminar el registro # {0}?', $status->statu_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
              </tbody>  
